...
import React__default, { createContext, useLayoutEffect, useEffect, useRef, useMemo, forwardRef } from 'react';
...
function SingleNumber(props) {
  ...
  if (prevValue === value || Number.isNaN(value) || Number.isNaN(prevValue)) {
    // Nothing to change
    unitNodes = [/*#__PURE__*/React.createElement(UnitNumber, _extends$1({}, props, {
      key: value,
      current: true
    }))];
    offsetStyle = {
    ...
    unitNodes = unitNumberList.map(function (n, index) {
      var singleUnit = n % 10;
      return /*#__PURE__*/React.createElement(UnitNumber, _extends$1({}, props, {
        key: n,
        value: singleUnit,
...
var Badge$1 = function Badge(_a) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends$1({}, restProps, {
    ...
    return /*#__PURE__*/React.createElement(ScrollNumber$1, {
...
var Badge = forwardRef(function (props, ref) {
    return (jsx(AntBadge, __assign({}, props, { style: {
            ...
            fontWeight: 600,
        } }, { children: jsx("p", { children: props.children }) })));
});
