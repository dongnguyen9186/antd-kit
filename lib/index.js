...
function WrapperField(_ref5) {
  var name = _ref5.name,
      restProps = _objectWithoutProperties(_ref5, _excluded$2);
...
var FormStore = /*#__PURE__*/_createClass(function FormStore(forceRootUpdate) {
  ...
  this.setInitialValues = function (initialValues, init) {
    ...
    if (init) {
      _this.store = setValues({}, _this.store, initialValues);
    }
  };
...
function SingleNumber(props) {
  ...
  var _React$useState3 = React__namespace.useState(count),
  ...
  if (prevValue === value || Number.isNaN(value) || Number.isNaN(prevValue)) {
    // Nothing to change
    unitNodes = [/*#__PURE__*/React__namespace.createElement(UnitNumber, _extends$1({}, props, {
      key: value,
      current: true
    }))];
    offsetStyle = {
    ...
    unitNodes = unitNumberList.map(function (n, index) {
      var singleUnit = n % 10;
      return /*#__PURE__*/React__namespace.createElement(UnitNumber, _extends$1({}, props, {
        key: n,
        value: singleUnit,
...
var ScrollNumber = function ScrollNumber(_a) {
  var customizePrefixCls = _a.prefixCls,
      ...
      children = _a.children,
      restProps = __rest$1(_a, ["prefixCls", "count", "className", "motionClassName", "style", "title", "show", "component", "children"]);
  ...
  if (count && Number(count) % 1 === 0) {
    ...
    numberNodes = numberList.map(function (num, i) {
      return /*#__PURE__*/React__namespace.createElement(SingleNumber, {
        prefixCls: prefixCls,
        count: Number(count),
  ...
  return /*#__PURE__*/React__namespace.createElement(component, newProps, numberNodes);
};

var ScrollNumber$1 = ScrollNumber;
...
var Badge$1 = function Badge(_a) {
  ...
  var displayCountRef = React.useRef(mergedCount);
  ...
  var statusTextNode = isHidden || !text ? null : /*#__PURE__*/React__namespace.createElement("span", {
    className: "".concat(prefixCls, "-status-text")
  }, text); // >>> Display Component

  var displayNode = !livingCount || _typeof(livingCount) !== 'object' ? undefined : cloneElement(livingCount, function (oriProps) {
    return {
      style: _extends$1(_extends$1({}, mergedStyle), oriProps.style)
    };
  }); // Shared styles
  ...
  if (!children && hasStatus) {
    ...
    return /*#__PURE__*/React__namespace.createElement("span", _extends$1({}, restProps, {
  ...
  return /*#__PURE__*/React__namespace.createElement("span", _extends$1({}, restProps, {
    ...
    var scrollNumberStyle = _extends$1({}, mergedStyle);
...
var Badge = React.forwardRef(function (props, ref) {
    return (jsxRuntime.jsx(AntBadge, __assign({}, props, { style: {
            ...
            fontWeight: 600,
        } }, { children: jsxRuntime.jsx("p", { children: props.children }) })));
});
